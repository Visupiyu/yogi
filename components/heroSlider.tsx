            ...
            >
              ...
              >
                <Link
                  ...
                  className="bg-gradient-to-r from-green-600 to-blue-600 hover:from-green-500 hover:to-blue-500 px-8 py-4 rounded-2xl text-lg font-semibold inline-block shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105"
                >
                  {slide.button}
                </Link>
              </motion.div>
