...
// The role / email-verification guard lives in the console layout and is
// UNCHANGED; this page is presentation + the approved Show/Hide + neutral
// Forgot-password UX only. Auth/authorization behaviour is unchanged.
...
export default function DeliveryCompanyLoginPage() {
  ...
  if (checking) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-gradient-to-b from-sky-50 to-blue-50 text-sm text-slate-500">
        Checking access…
      </div>
    );
  }
      ...
      <div className="w-full max-w-md">
        <div className="rounded-2xl border border-blue-100 bg-white p-7 shadow-xl shadow-blue-200/40 sm:p-8">
          <div className="mb-6 text-center">
            <span className="inline-block rounded-full border border-teal-100 bg-teal-50 px-3 py-1 text-[11px] font-semibold uppercase tracking-wide text-teal-700">
              Delivery Company
            </span>
            <h1 className="mt-3 text-2xl font-bold text-slate-900">YOMICO Operator Console</h1>
            <p className="mt-1 text-sm text-slate-500">Sign in to manage your delivery jobs and people</p>
          </div>
          ...
          <p className="mt-6 text-center text-sm text-slate-500">
            ...
            <Link href="/delivery-company-register" className="font-semibold text-blue-600 hover:underline">
