        ...
        <div className="bg-white p-8 rounded-2xl shadow space-y-6">
          ...
          <div>
            ...
            <p>
              ...
              Customers may cancel an order before it has been packed,
              shipped, or marked as dispatched. Once an order has entered
              the shipping process, cancellation may no longer be
              available.
          ...
          <div>
            ...
            <p>
              ...
              Sellers should avoid cancelling confirmed orders. Orders may
              only be cancelled due to genuine reasons such as stock
              unavailability, pricing errors, legal restrictions, or
...
may result in restrictions on using Pay on Delivery for future purchases.
          ...
          <div>
            ...
            <h2 className="text-2xl font-bold mb-2">
              6. Abuse of Cancellation Policy
            </h2>
