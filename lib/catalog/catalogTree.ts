...
// ============================================================
// Added: Men's fashion top-level categories (Footwear, Bags, Watches,
// Accessories, Grooming) to match the depth already present under
// Women, plus Shirts/Sweatshirts under Men > Clothing > Top Wear,
// which previously only had T-Shirts. Appended here rather than
// nested inline to avoid disturbing the existing (fragile) bracket
// structure elsewhere in this file — level/parentId is what actually
// determines where these show up, not physical position in the array.
// ============================================================
{
  id: "FASHION_MEN_FOOTWEAR",
  name: "Footwear",
  slug: "mens-footwear",
...
{
  id: "FASHION_MEN_GROOMING",
  name: "Grooming",
  slug: "mens-grooming",
  description: "Men's Grooming & Personal Care",
  icon: "sparkles",
  image: "",
  level: 3,
  parentId: "FASHION_MEN",
